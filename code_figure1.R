...
dat = read.csv("~/Desktop/weekly-flu-subtypes.csv")
...
covid <- read.csv("~/Desktop/owid-covid-data.csv")
...
top_plots <- plot_grid(plot_flu + theme(legend.justification = c(0,1)), plot_h1n1_2009 + theme(legend.justification = c(0,1)), ncol=1, align ="v")
...
frame_g4 <- gtable_frame(g3, debug = FALSE, width=unit(5.1,"null"))
