...
plot_cov_2020 <-ggplot(data=covid_usa_streamlined)+
  ...
  scale_x_date(date_breaks = "3 months", date_labels = "%b %Y") + theme(axis.text.x = element_text(angle = 90))
plot_cov_2020


#y axis for H1N1 & SARS-CoV-2 = New Cases/Total Specimens * 100 (% Positive)#
